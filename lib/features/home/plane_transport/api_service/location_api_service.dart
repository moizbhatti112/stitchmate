...
import 'package:stitchmate/features/home/plane_transport/api_service/autocomplete_response.dart';
import 'package:stitchmate/features/home/plane_transport/api_service/network_repo.dart';

class LocationApiService {
  /// Fetches place predictions based on user input
  static Future<List<AutocompletePrediction>> getPlacePredictions(
    String query,
  ) async {
    if (query.isEmpty) {
      return [];
