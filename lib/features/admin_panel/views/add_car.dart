...
Future<String?> _uploadImageToStorage() async {
  ...
  try {
    ...
    await Supabase.instance.client.storage
        .from('vehicleimages')  // Changed from 'vehicle_images' to 'vehicleimages'
        .upload(
          storagePath,
          _imageFile!,
  ...
  Future<void> _saveCar() async {
    ...
    if (_imageFile == null && _uploadedImageUrl == null) {
      setState(() {
        _errorMessage = 'Please select an image for the car';
      });
      return;
    }
    ...
    try {
      ...
      // Save to Supabase
      await Supabase.instance.client.from('vehicles').insert(car);
      ...
      setState(() {
        _errorMessage = 'Failed to add car: ${e.toString()}';
      });
    } finally {
      if (mounted) {
        setState(() {
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        ElevatedButton.icon(
                          ...
                          label: Text(_imageFile != null || _uploadedImageUrl != null 
                            ? 'Change Image' 
                            : 'Select Image'),
