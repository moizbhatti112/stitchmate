...
class ProfileImageChangeNotifier {
  // Singleton pattern
  static final ProfileImageChangeNotifier _instance = ProfileImageChangeNotifier._internal();
  ...
  final ValueNotifier<DateTime> lastUpdated = ValueNotifier<DateTime>(DateTime.now());
